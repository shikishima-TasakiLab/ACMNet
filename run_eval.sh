...
python val.py --model test --channels 64 --model_path checkpoints/_dcomp/latest_net_DC.pth --knn 6 6 6 --nsamples 10000 5000 2500 -vd datasets/kitti360_seq03.hdf5 -vdc datasets/kitti360_acmnet_val.json -bs 16 --save
